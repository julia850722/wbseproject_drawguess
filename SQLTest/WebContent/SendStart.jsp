...
///********
  ...
  function sendMessage(){
    ...
    FB.ui({
    	  method: 'send',
    	  link: 'https://goo.gl/WXHVZR',
		  to:  	document.getElementById("friend1").value,
    });
    FB.ui({
  	  method: 'send',
  	  link: 'https://goo.gl/WXHVZR',
		to:  		document.getElementById("friend2").value,
  });
    FB.ui({
  	  method: 'send',
  	  link: 'https://goo.gl/WXHVZR',
	  to:  		document.getElementById("friend3").value,
  });
					...
					<h2 class="title"></h2>
						<div style="clear: both;">&nbsp;</div>
							<div class="entry">
								...
								<button onClick="sendMessage()" class="send">send message to friends</button>
								...
								<form method="post" action="PlayerSelectServlet">
									<input type = "hidden" name = "PlayerId" value = "1"></input>
									<button class="box1"><span>進入遊戲</span></button>
								</form>
							</div>
				</div>
			</div>
